...
server-currency-name-singular = Bark Coin
server-currency-name-plural = Bark Coins
...
gs-balanceui-shop-buy-token-antag = Buy an Antag Token - {$price} Bark Coins
gs-balanceui-shop-buy-token-admin-abuse = Buy an Admin Abuse Token - {$price} Bark Coins
gs-balanceui-shop-buy-token-hat = Buy a Hat Token - {$price} Bark Coins
